...
describe("Logger Service", () => {
  ...
  describe("logger", () => {
    ...
    it("should include additional metadata in properties", async () => {
      ...
      logger.info("Message with metadata", { emailId: "email-123", action: "parse" });
  ...
  describe("createChildLogger", () => {
    it("should create a child logger with additional context", () => {
      const childLogger = createChildLogger({ reservationId: "res-123" });
    ...
    it("should include parent context in child logger", () => {
      ...
      const childLogger = createChildLogger({ reservationId: "res-456" });
