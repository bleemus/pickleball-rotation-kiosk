    ...
    <div className="lg:h-screen bg-gradient-to-br from-green-500 to-blue-600 p-2 lg:p-6 flex flex-col lg:overflow-hidden">
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:h-full">
        ...
        <div className="text-center mb-2 lg:mb-4 flex-shrink-0">
          ...
          <p className="text-base lg:text-xl xl:text-2xl text-white opacity-90">Current Matchups</p>
        </div>
              ...
              >
                <div className="text-center mb-1 lg:mb-3 flex-shrink-0">
                  ...
                  <p className="text-sm lg:text-base font-semibold h-5 lg:h-6">
                    {match.completed && <span className="text-green-600">Score Entered</span>}
                  </p>
                </div>
                ...
                <div className="space-y-1 lg:space-y-3 flex-1 flex flex-col justify-center lg:min-h-0">
                  ...
                  >
                    ...
                    {match.completed && (
                      <div
                        className={`ml-2 text-2xl lg:text-4xl font-bold ${team1Won ? "text-green-700" : "text-gray-600"}`}
                      >
                        {match.team1Score}
                      </div>
                    )}
                  ...
                  >
                    ...
                    {match.completed && (
                      <div
                        className={`ml-2 text-2xl lg:text-4xl font-bold ${team2Won ? "text-green-700" : "text-gray-600"}`}
                      >
                        {match.team2Score}
                      </div>
                    )}
